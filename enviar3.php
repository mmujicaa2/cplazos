                        ...
                        if ($result->num_rows > 0) {
                          while($row = $result->fetch_assoc()) {
                            ...
                            <body>
                                <div class=wit>
                                <div class=padding32>
                                    <h4 class='inline m-L'><b>Hoy vence un evento en el Sistema de Control de Plazos</b></h4>
                                    <br />
                                    <span class=''>Tipo de trámite $row[tipotramite]</span><br />
                                    ...
                                    <span class=''>Detalle: </span><span class=''>$row[observacion]</span><br /><br />
