...
<body>
    <div class=wit>
    <div class=padding32>
        <h4 class='inline m-L'><b>Se ha eliminado un evento en el Sistema de Control de Plazos</b></h4>
        <br />
...
$mail->Subject = 'Se ha eliminado un evento en sistema de control de Plazos ';
