...
<head>
    ...
    <input type="text" id="tipotramite" name="tipotramite"  style="width : 60%" required ><br>
...
<hr>
    ...
    <input type="hidden" id="era" name="era"  requied>
    <input type="hidden" id="tipoplazo" name="tipoplazo" >
<script>
$(document).ready(function () {
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <!--    <label for="prioridad">Prioridad:</label>
                ...
                <input type="hidden" id="editarAno" name="editarAno" required value="VALOR_ANTERIOR"><br>
...
.fc .fc-button-primary {
    ...
    border-color: rgb(247 247 247 / 25%);
